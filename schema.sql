...
CREATE TABLE IF NOT EXISTS `agro`.`likes` (
  ...
  INDEX `fk_users_has_publicaciones_publicaciones1_idx` (`publicacion_id` ASC) VISIBLE,
  INDEX `fk_users_has_publicaciones_users_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `agro`.`comentarios` (
  ...
  `publicacion_id` INT NOT NULL,
  PRIMARY KEY (`user_id`, `publicacion_id`),
  INDEX `fk_users_has_publicaciones_publicaciones2_idx` (`publicacion_id` ASC) VISIBLE,
  INDEX `fk_users_has_publicaciones_users1_idx` (`user_id` ASC) VISIBLE,
